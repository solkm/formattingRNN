...
title(sprintf('%s relative bias %d, choice frequency difference (ustim - no ustim)', layer, bias))
xlabel('motion direction relative to preference of perturbed units')
