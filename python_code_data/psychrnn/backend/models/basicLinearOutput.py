...
class Basic_linOut(RNN):
    """ The basic continuous time recurrent neural network model. Removed output nonlinearity.
    ...
    def output_timestep(self, state):
        ...
        output = tf.matmul(state, self.get_effective_W_out(), transpose_b=True, name="3") + self.b_out
