...
class DLPFC_combined(Task):
    def __init__(self, dt=10, tau=100, T=1200, N_batch=100, N_rec=100, in_noise=0.4,
                 ...
                 saveMTactivity=False, saveMTinput=False, saveMToutput=False):
        N_in = 3 + MT_NdirOuts
        N_out = 72
        ...
        self.saveMTinput = saveMTinput
        self.saveMToutput = saveMToutput
    ...
    def generate_trial_params(self, batch, trial):
        ...
        if trial==0: # new batch
            ...
            if self.saveMTinput==True:
                params['MTinput'] = MT_inputs
            if self.saveMToutput==True:
                params['MToutput'] = self.MT_output
